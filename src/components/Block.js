...
const Block = ({heading, description, img, }) => {
    return (
          <div className="border-box bg-bgblock shadow-block border-2 border-borderblock rounded-lg lg:flex lg:flex-col lg:justify-around lg:items-center lg:w-full lg:h-full ">
