...
const Block = ({heading, description, img, }) => {
    return (
          <div className="mx-12 bg-bgblock shadow-block border-2 border-borderblock rounded-large flex flex-col justify-center items-center h-5/6 lg:w-full lg:h-full ">
