...
const Navbar = ({logo}) => {
  ...
  return (
    <div className="flex flex-row items-center justify-between sticky top-0 h-28 bg-bgprimary">
      <a href="/" className="logo lg:ml-32">
        <img height="100%" width="100%" src={logo} alt="logo" />
             ...
             openNav &&
              <div ref={wrapperRef} className="absolute top-0 w-full h-48 bg-white">
                ...
                <div className="flex flex-col items-center justify-around h-full pt-5">
                  ...
                  <a onClick={()=>setOpenNav(false)} href="#discord" className="text-lg font-body text-white transition-all hover:text-navhover">Discord</a>
          ...
          <div className="flex justify-around w-3/5 mr-32 lg:visible sm:invisible">
              ...
              <div style={{width: '120px', height: '45px'}}>
                ...
                style={{background: 'linear-gradient(151.46deg, #01F2FF -14.78%, #0142FF 113.99%)'}}
                  className="font-body font-medium text-base text-center text-white transition-all rounded-small focus:ring2 shadow-2xl ring-2 w-full h-full -mt-4"
                >
                  Sign In
                </button>
